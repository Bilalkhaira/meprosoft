            ...
            <div class="card-body p-md-10 py-xl-11 px-xl-15">
                <div class="row gx-lg-8 gx-xl-0 gy-10 align-items-center">
                    ...
                    <div class="col-lg-6 text-center text-lg-start" data-cues="slideInDown" data-group="page-title"
                        ...
                        <p class="lead fs-lg lh-sm mb-7 pe-xl-10">Mesprosoft provides a broad portfolio of SAP & information technology solutions and business process to its clients worldwide.
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Mesprosoft has designed tailored solutions for industries across verticals. Mesprosoft has leveraged SAP technology and its superior features to build solutions that align perfectly with vertical…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Our SAP Upgrade services enable clients to extract full value from higher versions of SAP ERP. Our robust upgrade roadmap paves the way for broader transformational changes, which in turn deliver…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">In our role as a SAP support provider, Mesprosoft provides a high quality, consistent and high value support service. Mesprosoft’s SAP support covers the full spectrum of SAP functions, adjusts for peaks and troughs in demand…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Not only in India but also in Middle East, respective governments have introduced GST as the new Taxation Law. Mesprosoft have migrated all our customers successfully with GST within the …</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Mesprosoft Manufacturing Add-ons are solutions aimed at improving the Manufacturing processes and SAP utilization who are an existing customer of SAP. Each of our solutions can be implemented as standalone or combine to leverage the efficiency…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">The irony of the current times is that the Organizations have tons of data about themselves but unable to use them intelligently for their best results. Mesprosoft prebuilt templates reports and dashboards (Mespro BOBJ –GPS) allow you to quickly see thru…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Unlike conventional production reporting, Process Manufacturing cockpit a live data capturing at the assemblies or production process ,capturing the assembly parameters, test results , details of Serial numbers and bath details in a single cockpit which later generates itself a history card…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
                    <div class="col-md-6 col-lg-12 col-xl-6">
                        <div class="d-flex flex-row">
                            ...
                            <div>
                                ...
                                <p class="mb-0">With the traditional MRP, the planners were not able to execute the MRP at regular intervals and hence, creating a bottleneck. This is a peculiar case for the manufacturing units with a large amount of data to be processed. Mespro Optimized MRP helps…</p>
                            </div>
                        </div>
                    </div>
                    <!--/column -->
