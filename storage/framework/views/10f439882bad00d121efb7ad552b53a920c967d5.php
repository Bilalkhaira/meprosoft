...
<section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="<?php echo e(asset('img/photos/bg1.jpg')); ?>">
            ...
            <div class="row gx-md-5 gy-5">
              <div class="col-md-5 offset-md-1 align-self-end">
                <div class="card bg-pale-yellow">
                  <div class="card-body">
                    <img src="<?php echo e(asset('img/icons/lineal/telephone-3.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
                    <h4>24/7 Support</h4>
              ...
              <div class="col-md-6 align-self-end">
                <div class="card bg-pale-red">
                  <div class="card-body">
                    <img src="<?php echo e(asset('img/icons/lineal/shield.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
              ...
              <div class="col-md-5">
                <div class="card bg-pale-leaf">
                  <div class="card-body">
                    <img src="<?php echo e(asset('img/icons/lineal/cloud-computing-3.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
                    <h4>Daily Updates</h4>
              ...
              <div class="col-md-6 align-self-start">
                <div class="card bg-pale-primary">
                  <div class="card-body">
                    <img src="<?php echo e(asset('img/icons/lineal/analytics.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
        ...
        <div class="row text-center">
          <div class="col-lg-10 mx-auto">
            <div class="mt-lg-n20 mt-xl-n22 position-relative">
              ...
              <video poster="<?php echo e(asset('img/photos/movie.jpg')); ?>" class="player" playsinline controls preload="none">
        ...
        <div class="row text-center">
          <div class="col-lg-9 mx-auto">
            ...
            <div class="row gx-lg-8 gx-xl-12 process-wrapper text-center mt-9">
              <div class="col-md-4"> <img src="<?php echo e(asset('img/icons/lineal/light-bulb.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
                <h4 class="mb-1">1. Concept</h4>
                <p>Nulla vitae elit libero elit non porta gravida eget metus cras.</p>
              </div>
              <!--/column -->
              <div class="col-md-4"> <img src="<?php echo e(asset('img/icons/lineal/settings-3.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
                <h4 class="mb-1">2. Prepare</h4>
                <p>Nulla vitae elit libero elit non porta gravida eget metus cras.</p>
              </div>
              <!--/column -->
              <div class="col-md-4"> <img src="<?php echo e(asset('img/icons/lineal/design.svg')); ?>" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
          <div class="col-lg-7">
            <figure><img class="w-auto" src="<?php echo e(asset('img/illustrations/i8.png')); ?>" srcset="<?php echo e(asset('img/illustrations/i8@2x.png 2x')); ?>" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" src="<?php echo e(asset('img/illustrations/i7.png')); ?>" srcset="<?php echo e(asset('img/illustrations/i7@2x.png 2x')); ?>" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
    ...
    <!-- /section -->
    <section class="wrapper image-wrapper bg-auto no-overlay bg-image text-center bg-map" data-image-src="<?php echo e(asset('img/map.png')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/meprosoft/resources/views/pages/services/applicationMigrationConversion.blade.php ENDPATH**/ ?>