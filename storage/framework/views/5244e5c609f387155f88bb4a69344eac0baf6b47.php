...
<section class="wrapper bg-gray">
      <div class="container pt-10 pt-md-14 text-center">
        <div class="row">
          <div class="col-xl-6 mx-auto">
            <h1 class="display-1 mb-4">Hello! This is Mesprosoft</h1>
      ...
      <!-- /.container -->
      <figure class="position-absoute" style="bottom: 0; left: 0; z-index: 2;"><img src="<?php echo e(asset('img/photos/bg12.jpg')); ?>" alt="" /></figure>
    </section>
    <!-- /section -->
      ...
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-17 align-items-center">
          <div class="col-lg-6 position-relative order-lg-2">
            ...
            <div class="overlap-grid overlap-grid-2">
              <div class="item">
                <figure class="rounded shadow"><img src="<?php echo e(asset('img/photos/about2.jpg')); ?>" srcset="<?php echo e(asset('img/photos/about2@2x.jpg 2x')); ?>" alt=""></figure>
              </div>
              <div class="item">
                <figure class="rounded shadow"><img src="<?php echo e(asset('img/photos/about3.jpg')); ?>" srcset="<?php echo e(asset('img/photos/about3@2x.jpg 2x')); ?>" alt=""></figure>
              </div>
            </div>
          </div>
          <!--/column -->
          <div class="col-lg-6">
            <img src="<?php echo e(asset('img/icons/lineal/megaphone.svg')); ?>" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
            <h2 class="display-4 mb-3">About Mesprosoft</h2>
            <p class="lead fs-lg">“Mesprosoft” is derived from the words  Metrics, Processes and Software .</p>
            <p class="mb-6">We aim to improve the Business processes of our customers by building good metrics and processes using the world’s best software. All our products & Services current and future are lined up for this goal. Mesprosoft wants to extend its image beyond its customers as “the most trusted IT services Company”, which can deliver what it promise and add value to the customer.</p>
        ...
        <div class="row mb-5">
          <div class="col-md-10 col-xl-8 col-xxl-7 mx-auto text-center">
            <img src="<?php echo e(asset('img/icons/lineal/list.svg')); ?>" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
      ...
      <div class="container pt-16 pb-14 pb-md-0">
        <div class="row gx-lg-8 gx-xl-0 align-items-center">
          <div class="col-md-5 col-lg-5 col-xl-4 offset-xl-1 d-none d-md-flex position-relative align-self-end">
            ...
            <figure><img src="<?php echo e(asset('img/photos/co1.png')); ?>" srcset="<?php echo e(asset('img/photos/co1@2x.png 2x')); ?>" alt=""></figure>
          </div>
          <!--/column -->
      ...
      <div class="container py-14 py-md-16">
        <div class="row mb-3">
          <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
            <img src="<?php echo e(asset('img/icons/lineal/team.svg')); ?>" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te1.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te1@2x.jpg 2x')); ?>" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te2.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te2@2x.jpg 2x')); ?>" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te3.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te3@2x.jpg 2x')); ?>" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te4.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te4@2x.jpg 2x')); ?>" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te5.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te5@2x.jpg 2x')); ?>" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="<?php echo e(asset('img/avatars/te6.jpg')); ?>" srcset="<?php echo e(asset('img/avatars/te6@2x.jpg 2x')); ?>" alt="" />
        ...
        <div class="row mb-10">
          <div class="col-xl-10 mx-auto">
            <div class="row align-items-center counter-wrapper gy-6 text-center">
              <div class="col-md-3">
                <img src="<?php echo e(asset('img/icons/lineal/check.svg')); ?>" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">7518</h3>
                <p>Completed Projects</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="<?php echo e(asset('img/icons/lineal/user.svg')); ?>" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">3472</h3>
                <p>Satisfied Customers</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="<?php echo e(asset('img/icons/lineal/briefcase-2.svg')); ?>" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">2184</h3>
                <p>Expert Employees</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="<?php echo e(asset('img/icons/lineal/award-2.svg')); ?>" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
      ...
      <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
            ...
            <figure class="rounded"><img src="<?php echo e(asset('img/photos/about4.jpg')); ?>" srcset="<?php echo e(asset('img/photos/about4@2x.jpg 2x')); ?>" alt=""></figure>
          </div>
          <!--/column -->
          <div class="col-lg-6">
            <img src="<?php echo e(asset('img/icons/lineal/telemarketer.svg')); ?>" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
            ...
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0"><a href="/cdn-cgi/l/email-protection#8af9ebe4eee8e5f2caefe7ebe3e6a4e9e5e7" class="link-body"><span class="__cf_email__" data-cfemail="463527282224293e06232b272f2a6825292b">[email&#160;protected]</span></a></p>
              </div>
            </div>
          </div>
          <!--/column -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/zubairmohsin/code/sites/meprosoft/resources/views/pages/about.blade.php ENDPATH**/ ?>