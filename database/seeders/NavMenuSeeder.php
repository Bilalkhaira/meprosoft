...
class NavMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $services_nv = [
            ['name' => 'Application Migration & Conversion', 'parent_id' => $parent_id->id],
            ['name' => 'Enterprise Solution Consulting', 'parent_id' => $parent_id->id],
            ['name' => 'GST Migration', 'parent_id' => $parent_id->id],
            ...
            ['name' => 'Rise with S4 HANA Implementation', 'parent_id' => $parent_id->id],
            ['name' => 'SAP Support', 'parent_id' => $parent_id->id],
            ['name' => 'Digital Manufacturing Cloud', 'parent_id' => $parent_id->id],
            ['name' => 'ALM(Application Life Cycle Management)', 'parent_id' => $parent_id->id],
            ['name' => 'SAP Fiori Development', 'parent_id' => $parent_id->id],
        ];
        ...
        $case_study_nv = [
            ...
            ['name' => 'S/4 Hana Private cloud', 'parent_id' => $parent_id->id],
