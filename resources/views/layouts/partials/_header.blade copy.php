                                        ...
                                        <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-4 gy-lg-2 list-unstyled">
                                            <li class="col"><a class="dropdown-item" href="./demo1.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi1@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo2.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi2@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo3.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi3@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo4.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi4@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo5.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi5@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo6.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi6@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo7.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi7@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo8.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi8@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo9.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi9@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo10.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi10@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo11.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi11@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo12.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi12@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo13.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi13@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo14.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi14@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo15.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi15@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo16.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi16@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo17.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi17@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo18.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi18@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo19.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi19@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo20.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi20@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo21.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi21@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo22.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi22@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo23.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi23@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo24.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi24@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo25.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi25@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo26.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi26@2x.jpg 2x') }}" alt="">
                                                    </figure>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./demo27.html">
                                                    <figure class="rounded lift d-none d-lg-block"><img
                                                            ...
                                                            srcset="{{ asset('img/demos/mi27@2x.jpg 2x') }}" alt="">
                                                    </figure>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown dropdown-submenu dropend"><a
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a class="dropdown-item" href="./shop.html">Shop I</a>
                                            </li>
                                        ...
                                        <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/about.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block1.svg') }}"
                                                            alt=""></div>
                                                    <span>About</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/blog.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block2.svg') }}"
                                                            alt=""></div>
                                                    <span>Blog</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item"
                                                    ...
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block3.svg') }}"
                                                            alt=""></div>
                                            ...
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/clients.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block4.svg') }}"
                                                            alt=""></div>
                                                    <span>Clients</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/contact.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block5.svg') }}"
                                                            alt=""></div>
                                                    <span>Contact</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/facts.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block6.svg') }}"
                                                            alt=""></div>
                                                    <span>Facts</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/faq.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block7.svg') }}"
                                                            alt=""></div>
                                                    <span>FAQ</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/features.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block8.svg') }}"
                                                            alt=""></div>
                                                    <span>Features</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/footer.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block9.svg') }}"
                                                            alt=""></div>
                                                    <span>Footer</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/hero.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block10.svg') }}"
                                                            alt=""></div>
                                                    <span>Hero</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/misc.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block17.svg') }}"
                                                            alt=""></div>
                                                    <span>Misc</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/navbar.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block11.svg') }}"
                                                            alt=""></div>
                                                    <span>Navbar</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item"
                                                    ...
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block12.svg') }}"
                                                            alt=""></div>
                                                    <span>Portfolio</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/pricing.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block13.svg') }}"
                                                            alt=""></div>
                                                    <span>Pricing</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/process.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block14.svg') }}"
                                                            alt=""></div>
                                                    <span>Process</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item" href="./docs/blocks/team.html">
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block15.svg') }}"
                                                            alt=""></div>
                                                    <span>Team</span>
                                                </a>
                                            </li>
                                            <li class="col"><a class="dropdown-item"
                                                    ...
                                                    <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img
                                                            class="rounded-0" src="{{ asset('img/demos/block16.svg') }}"
                                                            alt=""></div>
