                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        <form action="">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-4 col-lg-2 label">Upload Image</label>
                                <div class="col-md-8 col-lg-10">
...
<script>
    $(document).on('click', '.add_more', function(e) {
        e.preventDefault();
        var data;
        data = '<div class="row mb-3"><label class="col-md-4 col-lg-2 label">Question</label><div class="col-md-8 col-lg-4"><textarea name="" id="" class="form-control" cols="30" rows="3"></textarea></div><label class="col-md-4 col-lg-1 label">Answer</label>';
        data += '<div class="col-md-8 col-lg-4"><textarea name="" id="" class="form-control" cols="30" rows="3"></textarea></div><div class="col-md-1"><button class="btn btn-success remove_more">remove</button></div>';
