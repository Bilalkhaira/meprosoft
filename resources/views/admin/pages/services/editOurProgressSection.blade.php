...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Our Progress Sectoin</li>
        </ol>
    </nav>
</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="pt-3 setting_main">
                        <form action="">
                            <div class="row mb-3">
                                <label class="col-md-4 col-lg-2 label">Section Small Heading</label>
                                <div class="col-md-8 col-lg-10">
                                    <input name="heading" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-md-4 col-lg-2 label">Section Larg Text</label>
                                <div class="col-md-8 col-lg-10">
                                    <textarea name="" class="form-control" id="" cols="30" rows="4"></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-md-4 col-lg-2 label">Section Video Upload</label>
                                <div class="col-md-8 col-lg-10">
