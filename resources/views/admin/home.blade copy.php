...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('img/admin/img/favicon.png') }}" rel="icon">
  <link href="{{ asset('img/admin/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  src="{{ asset('img/admin/img/lineal/browser.svg') }}"
</head>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{ asset('img/admin/img/logo.png') }}" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{ asset('img/admin/img/profile-img.jpg') }}" alt="Profile" class="rounded-circle">
