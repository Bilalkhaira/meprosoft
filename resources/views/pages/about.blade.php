...
<section class="wrapper bg-gray">
      ...
      <!-- /.container -->
      <figure class="position-absoute" style="bottom: 0; left: 0; z-index: 2;"><img src="{{ asset('img/photos/bg12.jpg') }}" alt="" /></figure>
    </section>
    <!-- /section -->
      ...
      <div class="container pt-16 pb-14 pb-md-0">
        <div class="row gx-lg-8 gx-xl-0 align-items-center">
          <div class="col-md-5 col-lg-5 col-xl-4 offset-xl-1 d-none d-md-flex position-relative align-self-end">
            ...
            <figure><img src="{{ asset('img/photos/co1.png') }}" srcset="{{ asset('img/photos/co1@2x.png 2x') }}" alt=""></figure>
          </div>
          <!--/column -->
      ...
      <div class="container py-14 py-md-16">
        <div class="row mb-3">
          <div class="col-md-10 col-xl-9 col-xxl-7 mx-auto text-center">
            <img src="{{ asset('img/icons/lineal/team.svg') }}" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te1.jpg') }}" srcset="{{ asset('img/avatars/te1@2x.jpg 2x') }}" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te2.jpg') }}" srcset="{{ asset('img/avatars/te2@2x.jpg 2x') }}" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te3.jpg') }}" srcset="{{ asset('img/avatars/te3@2x.jpg 2x') }}" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te4.jpg') }}" srcset="{{ asset('img/avatars/te4@2x.jpg 2x') }}" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te5.jpg') }}" srcset="{{ asset('img/avatars/te5@2x.jpg 2x') }}" alt="" />
                ...
                <div class="swiper-slide">
                  <div class="item-inner">
                    <div class="card">
                      <div class="card-body">
                        <img class="rounded-circle w-15 mb-4" src="{{ asset('img/avatars/te6.jpg') }}" srcset="{{ asset('img/avatars/te6@2x.jpg 2x') }}" alt="" />
        ...
        <div class="row mb-10">
          <div class="col-xl-10 mx-auto">
            <div class="row align-items-center counter-wrapper gy-6 text-center">
              <div class="col-md-3">
                <img src="{{ asset('img/icons/lineal/check.svg') }}" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">7518</h3>
                <p>Completed Projects</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="{{ asset('img/icons/lineal/user.svg') }}" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">3472</h3>
                <p>Satisfied Customers</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="{{ asset('img/icons/lineal/briefcase-2.svg') }}" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
                <h3 class="counter">2184</h3>
                <p>Expert Employees</p>
              </div>
              <!--/column -->
              <div class="col-md-3">
                <img src="{{ asset('img/icons/lineal/award-2.svg') }}" class="svg-inject icon-svg icon-svg-lg text-primary mb-3" alt="" />
      ...
      <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
            ...
            <figure class="rounded"><img src="{{ asset('img/photos/about4.jpg') }}" srcset="{{ asset('img/photos/about4@2x.jpg 2x') }}" alt=""></figure>
          </div>
          <!--/column -->
          <div class="col-lg-6">
