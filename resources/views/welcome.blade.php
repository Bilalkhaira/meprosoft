    ...
    <div class="container">
        ...
        <div class="card bg-soft-primary rounded-4 mt-2 mb-13">
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-20 align-items-center">
                ...
                <div class="col-lg-6">
                    <h2 id="heading" class="display-4 mb-3 box animate fadeInLeft three">{{ $our_services->main_heading ?? ''}}</h2>
                    <div class="row gx-xl-10 gy-6 box animate fadeIn five">
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="d-flex flex-row">
                                <div>
                                ...
                                <div>
                                    <a href="{{ route('services.businessConsulting') }}">
                                        <h4 id="heading" class="mb-1">Business Consulting</h4>
                                    </a>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div>
                                    <a href="{{ route('services.digitalTransformationWithCloud') }}">
                                        <h4 id="heading" class="mb-1">Digital Transformation With Cloud</h4>
                                    </a>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div>
                                    <a href="{{route('services.hanaConversion')}}">
                                        <h4 id="heading" class="mb-1">S/4 Hana Conversion</h4>
                                    </a>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div>
                                    <a href="{{ route('services.applicationSupport') }}">
                                        <h4 id="heading" class="mb-1">Application Support</h4>
                                    </a>
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div>
                                    <a href="{{ route('services.specificConsulting') }}">
                                        <h4 id="heading" class="mb-1">Specific Consulting</h4>
                                    </a>
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-18 align-items-center">
                ...
                <div class="col-lg-6">
                    <h2 id="heading" class="display-4 mb-3 box animate fadeInRight four">{{ $building_efficiency->main_heading ?? ''}}</h2>
                    <p class="lead fs-lg box animate fadeIn five">{{ $building_efficiency->text ?? ''}}</p>
